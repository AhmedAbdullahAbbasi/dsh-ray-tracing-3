...
angular-distance cloud input (`clouds.py`), random interaction sampling
(`sampling.py`), source-packet transport and JAX parallelization
(`transport.py`), voxel geometry, imaging, plotting, and device reporting.
"""
